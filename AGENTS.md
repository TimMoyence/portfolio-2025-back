...
This project is indexed by GitNexus as **portfolio-2025-back** (6181 symbols, 17664 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
...
| Index, status, clean, wiki commands          | `.claude/skills/gitnexus/gitnexus-cli/SKILL.md`             |
