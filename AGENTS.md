...
> Ce projet est indexe par GitNexus (**portfolio-2025-back** : 5178 symboles, 14718 relations, 298 flux). Les regles d'utilisation (Always Do, When Debugging, When Refactoring, Never Do, Tools Quick Reference, Impact Risk Levels, Self-Check) sont decrites en detail dans **`CLAUDE.md`** (meme dossier).
>
